...
class BootstrapTouchspinWidget extends \BootstrapUI\View\Widget\BasicWidget
{
    ...
    public function render(array $data, ContextInterface $context)
    {
        ...
        $data['value'] = $data['val'];
        $data['class'] = $this->_generateFieldClass('ft-bootstrap-touchspin', $data['name']);
        ...
        echo $this->_View->Html->script('FieldTypes.../vendor/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.js', ['block' => 'headjs']);
        echo $this->_View->Html->css('FieldTypes.../vendor/bootstrap-touchspin/dist/jquery.bootstrap-touchspin.min.css', ['block' => 'css']);

        // Script call
        $this->_View->Html->scriptStart(['block' => true]);
        echo '$(document).ready(function() { $(".'.$data['class'].'").TouchSpin('.(json_encode($ftOptions, true)).'); });';
